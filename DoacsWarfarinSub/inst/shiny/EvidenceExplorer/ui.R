  ...
  fluidPage(style = "width:1500px;",
            ...
            tabsetPanel(id = "mainTabsetPanel",
                        tabPanel("About",
                                 ...
                                 HTML("<li>Using real-world data, the incidence of severe uterine bleeding was low but varied by antithrombotic therapy and occurred more often in patients with venous thromboembolism (VTE) versus those with non-valvular atrial fibrillation (NVAF).</li>"),
