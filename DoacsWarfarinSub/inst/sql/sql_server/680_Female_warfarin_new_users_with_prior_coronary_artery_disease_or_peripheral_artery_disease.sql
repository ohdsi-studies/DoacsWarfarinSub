...
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (37395821)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (37395821)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (315558,35205164,46270348,46270350)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (315558,35205164,46270348,46270350)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (2101660,4263062,2105103,42539735,4079258,4079260,4142076,4079259,2774102,2774106,2774103,2774105,2774104,2774097,2774101,2774098,2774100,2774099,4076468,4266062,4076070,43531648)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (2101660,4263062,2105103,42539735,4079258,4079260,4142076,4079259,2774102,2774106,2774103,2774105,2774104,2774097,2774101,2774098,2774100,2774099,4076468,4266062,4076070,43531648)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4127886,45889633,2890751)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4127886,45889633,2890751)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (37119535,4302555,37119544,37119545,195867,440155,195321)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4302555,37119544,37119545,195321)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (194696)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1369939,19000729,21502572,21500145,21500137,40250176,21500146,21502571,1517070,36234886,36234887,21602472,4275113,1718400,1303425,4197724)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1369939,19000729,21502572,21500145,21500137,40250176,21500146,21502571,1517070,36234886,36234887,21602472,4275113,1718400,1303425,4197724)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (2101815,2101809,2101015,2101000,2101808,2101597,2101592,2004524,42733496,2110163,4015660,2110171,4141940,2110203,42739908,2110204,1314496,1314497,4127886,2110228,2722224,2722227,2110223,2722223,2110226,2722226,2722225,2722222,2110292,2722207,2868153,2802049,2004527,2004444,2004491,2004449,2004503,195599,2722229,40756770,40756808,2721144,2108349,197236)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (2101815,2101809,2101015,2101000,2101808,2101597,2101592,42733496,2110163,2110171,2110203,42739908,2110204,1314496,1314497,4127886,2110228,2722224,2722227,2110223,2722223,2110226,2722226,2722225,2722222,2110292,2722207,2868153,2802049,2722229,2721144,2108349,197236)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4300370,4181912)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (38003219,4125928,2720538,2720527,2720555,2720537,2720556,2720522,2720539,2720528,2720549,2720552)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4125928)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1549080)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1549080)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (40228152)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
WHERE (C.drug_exposure_start_date >= DATEFROMPARTS(2010, 10, 19) and C.drug_exposure_start_date <= DATEFROMPARTS(2018, 12, 31))
...
JOIN #Codesets codesets on ((de.device_concept_id = codesets.concept_id and codesets.codeset_id = 9))
) C
...
) A on A.person_id = P.person_id  AND A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= P.OP_END_DATE AND A.START_DATE >= DATEADD(day,-35,P.START_DATE) AND A.START_DATE <= DATEADD(day,0,P.START_DATE)
GROUP BY p.person_id, p.event_id
HAVING COUNT(A.TARGET_CONCEPT_ID) = 0
-- End Correlated Criteria
...
FROM (
	...
	FROM @cdm_database_schema.DRUG_EXPOSURE de
	JOIN ctePersons p on de.person_id = p.person_id
	JOIN #Codesets cs on cs.codeset_id = 14 AND de.drug_source_concept_id = cs.concept_id
) E
;
...
(
  ...
  (
    ...
    (
      --cteEndDates
      select PERSON_ID, DATEADD(day,-1 * 7,EVENT_DATE) as END_DATE -- unpad the end date by 7
      FROM
      (
				...
				(
					...
					-- add the end dates with NULL as the row number, padding the end dates by 7 to allow a grace period for overlapping ranges.
					select PERSON_ID, DATEADD(day,7,DRUG_EXPOSURE_END_DATE), 1 as EVENT_TYPE, NULL
					FROM #drugTarget D
				) RAWDATA
      ) E
