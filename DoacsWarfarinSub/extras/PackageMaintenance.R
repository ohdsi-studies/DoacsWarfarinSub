...
OhdsiRTools::checkUsagePackage("DoacsWarfarinSub")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/DoacsWarfarinSub.pdf")
shell("R CMD Rd2pdf ./ --output=extras/DoacsWarfarinSub.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("DoacsWarfarinSub")
